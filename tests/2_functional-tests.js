...
suite('Functional Tests', () => {
    ...
    test("Solve a puzzle with invaild characters: POST request to /api/solve", function (done) {
        chai
        .request(server)
        .post("/api/solve")
        .send({ 
    ...
    test("Solve a puzzle wiht inccorect length: POST to /api/solve", function (done) {
        chai
        .request(server)
        .post("/api/solve")
        .send({
    ...
    test("Check a puzzle placement with invalid placement value: POST request to /api/check", function (done) {
        ...
        .request(server)
        .post("/api/check")
        .send({ puzzle: validPuzzle, coordinate: "A2", value: "z" })
        .end(function (err, res) {
            assert.equal(res.status, 200);
